...
<section class="rt_wrap content mCustomScrollbar">
 ...
 <div class="rt_content">
     ...
     <h1 style="color:red;font-size:20px;font-weight:bold;text-align:center;">欢迎访问xxx后台系统！</h1>
...
<!-- 
     ...
     <section>
      ...
      <div class="page_title">
       <h2 class="fl">订单列表</h2>
       <a class="fr top_rt_btn" href="{{ url('admin/orderlist') }}">查看更多</a>
      </div>
      <table class="table" style="text-align: center;">
       <tr>
        ...
        @foreach($order as $or)
       <tr>
        <td style="width:265px;">{{ $or->order_sn }}</td>
        <td>{{ $or->username }}</td>
        <td>{{ $or->mobile_fan }}</td>
        <td>{{ $or->addr }}</td>
        <td>{{ $or->total_price }}</td>
        <td>{{ $orderStatus[$or->status] }}</td>
       </tr>
       @endforeach
      </table>
     <!--  <aside class="paging">
...
<script src="{{URL::asset('admin/js/amcharts.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('admin/js/serial.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('admin/js/pie.js')}}" type="text/javascript"></script>
