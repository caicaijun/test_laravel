...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     <form method="post" action='{{ url("admin/prodetail") }}' enctype="multipart/form-data" id="form1">
        {!! csrf_field() !!}
     ...
     <section>
      <ul class="ulColumn2">
        ...
        <input type="text" class="textbox textbox_295" name="shop_id" placeholder="商家选择"/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">商品名称：</span>
        <input type="text" class="textbox textbox_295" name="title" placeholder="商品名称..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
       ...
       <li>
        ...
        <input type="text" class="textbox" name="set_price" placeholder="商品结算价格"/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
       ...
       <li>
        ...
        <label class="uploadImg" style="height: 100px;">
         ...
         <input type="hidden" class="picDis" name="picture">
         <!-- <span>上传图片</span> -->
        </label>
         <img src="/wei.jpg" id="photo_img" display="none" style="width: 150px;height: 150px;">
       </li>
       <li>
